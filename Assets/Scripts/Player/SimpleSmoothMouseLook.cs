...
public class SimpleSmoothMouseLook : MonoBehaviour {
	...
	public Transform WhereShouldBe;
	...
	void LateUpdate(){
		transform.position = WhereShouldBe.position;
		UpdateTargetAim ();
	}

	void UpdateTargetAim(){
		RaycastHit[] hits;
		hits = Physics.RaycastAll(transform.position, transform.forward, 400.0f);
