...
public class CamaraJugador : MonoBehaviour {
	...
	private float MinViewDistance = 5f;
	...
	void Start () {
		...
		Transform pointer = transform.parent;
		CameraTarget = pointer;
	...
	void LateUpdate () {
		...
		if(CameraTarget)
			position = CameraTarget.position - (rotation * Vector3.forward * desireDistance);
